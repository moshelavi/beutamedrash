...
const libraryDB = {
    talmud: [
        { name: "ברכות", units: 63 * 2, linkKey: "Berakhot" }, // 64-1 = 63 pages
        { name: "שבת", units: 156 * 2, linkKey: "Shabbat" },
        { name: "עירובין", units: 104 * 2, linkKey: "Eruvin" },
        { name: "פסחים", units: 120 * 2, linkKey: "Pesachim" },
        { name: "שקלים", units: 21 * 2, linkKey: "Shekalim" },
        { name: "יומא", units: 87 * 2, linkKey: "Yoma" },
        { name: "סוכה", units: 55 * 2, linkKey: "Sukkah" },
        { name: "ביצה", units: 39 * 2, linkKey: "Beitzah" },
        { name: "ראש השנה", units: 34 * 2, linkKey: "Rosh_Hashanah" },
        { name: "תענית", units: 30 * 2, linkKey: "Taanit" },
        { name: "מגילה", units: 31 * 2, linkKey: "Megillah" },
        { name: "מועד קטן", units: 28 * 2, linkKey: "Moed_Katan" },
        { name: "חגיגה", units: 26 * 2, linkKey: "Chagigah" },
        { name: "יבמות", units: 121 * 2, linkKey: "Yevamot" },
        { name: "כתובות", units: 111 * 2, linkKey: "Ketubot" },
        { name: "נדרים", units: 90 * 2, linkKey: "Nedarim" },
        { name: "נזיר", units: 65 * 2, linkKey: "Nazir" },
        { name: "סוטה", units: 48 * 2, linkKey: "Sotah" },
        { name: "גיטין", units: 89 * 2, linkKey: "Gittin" },
        { name: "קידושין", units: 81 * 2, linkKey: "Kiddushin" },
        { name: "בבא קמא", units: 118 * 2, linkKey: "Bava_Kamma" },
        { name: "בבא מציעא", units: 118 * 2, linkKey: "Bava_Metzia" },
        { name: "בבא בתרא", units: 175 * 2, linkKey: "Bava_Batra" },
        { name: "סנהדרין", units: 112 * 2, linkKey: "Sanhedrin" },
        { name: "מכות", units: 23 * 2, linkKey: "Makkot" },
        { name: "שבועות", units: 48 * 2, linkKey: "Shevuot" },
        { name: "עבודה זרה", units: 75 * 2, linkKey: "Avodah_Zarah" },
        { name: "הוריות", units: 13 * 2, linkKey: "Horayot" },
        { name: "זבחים", units: 119 * 2, linkKey: "Zevachim" },
        { name: "מנחות", units: 109 * 2, linkKey: "Menachot" },
        { name: "חולין", units: 141 * 2, linkKey: "Chullin" },
        { name: "בכורות", units: 60 * 2, linkKey: "Bekhorot" },
        { name: "ערכין", units: 33 * 2, linkKey: "Arakhin" },
        { name: "תמורה", units: 33 * 2, linkKey: "Temurah" },
        { name: "כריתות", units: 27 * 2, linkKey: "Keritot" },
        { name: "מעילה", units: 21 * 2, linkKey: "Meilah" },
        { name: "נידה", units: 72 * 2, linkKey: "Niddah" }
    ],
    mishnah: [
        { name: "סדר זרעים", units: 11, linkKey: "Mishnah_Zeraim" },
        { name: "סדר מועד", units: 12, linkKey: "Mishnah_Moed" },
        { name: "סדר נשים", units: 7, linkKey: "Mishnah_Nashim" },
        { name: "סדר נזיקין", units: 10, linkKey: "Mishnah_Nezikin" },
        { name: "סדר קדשים", units: 11, linkKey: "Mishnah_Kodashim" },
        { name: "סדר טהרות", units: 12, linkKey: "Mishnah_Tohorot" }
    ],
    halacha: [
        { name: "משנה תורה - מדע", units: 5, linkKey: "Mishneh_Torah,_Sefer_Mada" },
        { name: "משנה תורה - אהבה", units: 6, linkKey: "Mishneh_Torah,_Sefer_Ahavah" },
        { name: "משנה תורה - זמנים", units: 10, linkKey: "Mishneh_Torah,_Sefer_Zemanim" },
        { name: "שולחן ערוך - אורח חיים", units: 697, linkKey: "Shulchan_Arukh,_Orach_Chayim" },
        { name: "שולחן ערוך - יורה דעה", units: 403, linkKey: "Shulchan_Arukh,_Yoreh_De'ah" },
        { name: "שולחן ערוך - אבן העזר", units: 178, linkKey: "Shulchan_Arukh,_Eben_HaEzer" },
        { name: "שולחן ערוך - חושן משפט", units: 427, linkKey: "Shulchan_Arukh,_Choshen_Mishpat" },
        { name: "משנה ברורה (חלק א')", units: 127, linkKey: "Mishnah_Berurah" },
        { name: "קיצור שולחן ערוך", units: 221, linkKey: "Kitzur_Shulchan_Arukh" }
    ],
    musar: [
        { name: "מסילת ישרים", units: 26, linkKey: "Mesillat_Yesharim" },
        { name: "שמירת הלשון", units: 34, linkKey: "Chofetz_Chaim" },
        { name: "חובת הלבבות", units: 10, linkKey: "Chovot_HaLevavot" },
        { name: "שערי תשובה", units: 4, linkKey: "Shaarei_Teshuvah" },
        { name: "תומר דבורה", units: 10, linkKey: "Tomer_Devorah" },
        { name: "נפש החיים", units: 4, linkKey: "Nefesh_HaChayim" }
    ],
    torah: [
        { name: "בראשית", units: 50, linkKey: "Genesis" },
        { name: "שמות", units: 40, linkKey: "Exodus" },
        { name: "ויקרא", units: 27, linkKey: "Leviticus" },
        { name: "במדבר", units: 36, linkKey: "Numbers" },
        { name: "דברים", units: 34, linkKey: "Deuteronomy" },
        { name: "תהילים", units: 150, linkKey: "Psalms" },
        { name: "שיר השירים", units: 8, linkKey: "Song_of_Songs" },
        { name: "קהלת", units: 12, linkKey: "Ecclesiastes" },
        { name: "משלי", units: 31, linkKey: "Proverbs" }
    ],
    other: [
        { name: "ספר הזוהר", units: 1000, linkKey: "Zohar" },
        { name: "מורה נבוכים", units: 178, linkKey: "Guide_for_the_Perplexed" },
        { name: "ספר אחר (כללי)", units: 100, linkKey: "" }
    ]
};
...
function openGeneralSearch() {
    const modal = document.getElementById('generalSearchModal');
...
async function searchLibraryBooks(query) {
    const results = [];
    for (const cat in libraryDB) {
        libraryDB[cat].forEach(book => {
            if (book.name.includes(query)) {
                results.push({ name: book.name, units: book.units, category: cat });
            }
        });
    }
    return results;
...
async function handleSignup(e) {
    ...
    try {
        ...
        await customAlert("החשבון נוצר בהצלחה! כעת ניתן להתחבר.");
...
function populateBooks() {
    ...
    const bookSelectDiv = document.getElementById('bookSelectDiv');
    const sefariaDiv = document.getElementById('sefariaSearchDiv');

    bookSelect.innerHTML = '';
    customDiv.style.display = 'none'; bookSelectDiv.style.display = 'none'; if (sefariaDiv) sefariaDiv.style.display = 'none';

    if (cat === 'custom') { customDiv.style.display = 'block'; }
    else if (cat === 'sefaria') { if (sefariaDiv) sefariaDiv.style.display = 'block'; }
    else {
        bookSelectDiv.style.display = 'block';
        if (cat && libraryDB[cat]) {
            libraryDB[cat].forEach(book => {
                const opt = document.createElement('option');
                opt.value = JSON.stringify(book);
                opt.innerText = `${book.name} (${book.units})`;
...
let sefariaDebounce;
async function handleSefariaSearch(query) {
    if (query.length < 2) { document.getElementById('sefariaResults').style.display = 'none'; return; }
    clearTimeout(sefariaDebounce);

    sefariaDebounce = setTimeout(async () => {
        try {
            const res = await fetch(`https://www.sefaria.org.il/api/name/${query}?limit=10&lang=he`);
            const data = await res.json();
            const list = document.getElementById('sefariaResults');
            list.innerHTML = '';
            if (data.completions && data.completions.length > 0) {
                ...
                data.completions.forEach(book => {
                    ...
                    li.innerText = book;
                    li.onclick = () => { document.getElementById('sefariaSearchInput').value = book; list.style.display = 'none'; };
                    list.appendChild(li);
                });
            }
...
async function addNewGoal() {
    ...
    const sefariaInput = document.getElementById('sefariaSearchInput');
    ...
    if (quickAmountEl && quickAmountEl.value) {
        ...
        } else if (category === 'sefaria') {
            bookName = sefariaInput.value;
            totalUnits = 100; // ברירת מחדל לספרים חיצוניים
        } else if (bookSelectEl && bookSelectEl.value) {
...
function renderLeaderboard() {
    ...
    // 3. מיון והצגה
    all.sort((a, b) => b.learned - a.learned).forEach((u, i) => {
        const tr = document.createElement('tr');
        // אם זה 'אני', שולחים מזהה מיוחד, אחרת את האימייל
        const idToSend = u.id === 'me' ? 'me' : u.email;

        tr.onclick = () => showUserDetails(idToSend);

        const badge = getUserBadgeHtml(u);
        tr.innerHTML = `<td><span class="rank-badge ${i === 0 ? 'rank-1' : ''}">${i + 1}</span></td><td>${badge}${u.name}<br><small>${getRankName(u.learned)}</small></td><td>${u.learned}</td>`;
...
async function findChavruta(bookName) {
    ...
    const title = document.getElementById('chavrutaBookTitle');
    const list = document.getElementById('chavrutaResultsList');

    if (title) title.innerText = bookName;
    if (list) list.innerHTML = '<div style="text-align:center; padding:10px;">טוען נתונים מהענן...</div>';
    if (modal) modal.style.display = 'flex';
    if (modal) bringToFront(modal);

    try {
        // UI עדכון סטטוס חיפוש
        list.innerHTML = `
            <div style="text-align:center; padding:20px;">
                <div style="margin-bottom:10px;"><i class="fas fa-circle-notch fa-spin" style="color:var(--primary); font-size:2rem;"></i></div>
                <div id="searchStatusText" style="color:#64748b;">בודק התאמה לפי עיר...</div>
            </div>`;

        // משיכת נתונים טריים מהענן כדי לראות את המשתמש השני באמת
        ...
        // סינון: רק משתמשים אחרים שלומדים כרגע משהו
        const matches = remoteUsers.filter(u => u.email !== currentUser.email);

        // דימוי תהליך בדיקה למשתמש
        await new Promise(r => setTimeout(r, 600));
        document.getElementById('searchStatusText').innerText = "בודק עיר זהה...";
        await new Promise(r => setTimeout(r, 600));
        document.getElementById('searchStatusText').innerText = "בודק התאמה בדרגות...";
        await new Promise(r => setTimeout(r, 600));
        document.getElementById('searchStatusText').innerText = "בודק היסטוריית לימוד...";
        await new Promise(r => setTimeout(r, 400));

        // חישוב ניקוד לכל משתמש
        const myCity = currentUser.city ? currentUser.city.trim().toLowerCase() : "";
        const myRank = getRankName(userGoals.reduce((sum, g) => sum + g.currentUnit, 0)); // חישוב דרגה שלי

        matches.forEach(u => {
            u.matchScore = 0;
            // סדר עדיפויות: גיל, עיר, דרגה, היסטוריה, שם
            // א. גיל (עשירייה)
            ...
            // ב. אותו דרגה
            // נניח שיש לנו את הניקוד שלהם ב-globalUsersData או נחשב בערך
            // לצורך הפשטות נשתמש בנתון הקיים אם יש, או 0
            ...
            // ג. לימוד דומה בעבר (היסטוריה) - בדיקה אם למדנו ספרים זהים
            // זה דורש מידע נוסף, נשתמש בבדיקה פשוטה אם יש חפיפה בספרים
            // כרגע אין לנו היסטוריה מלאה של כולם זמינה כאן, אז ניתן ניקוד אקראי קטן כ"היסטוריה" או נדלג
            // נדמה את זה:
            if (Math.random() > 0.7) u.matchScore += 30;

            // ד. שם דומה (בדיקה פשוטה של אותיות משותפות או התחלה זהה)
        ...
        list.innerHTML = ''; // ניקוי הודעת הטעינה

        if (matches.length === 0) {
            list.innerHTML = '<div style="text-align:center; padding:10px;">לא נמצאו לומדים אחרים כרגע.</div>';
        } else {
            matches.forEach(user => {
                const displayName = user.isAnonymous ? "לומד אנונימי" : (user.display_name || user.name || "לומד");

                const badge = getUserBadgeHtml(user);
                // כפתור שליחת בקשה לענן
                const buttonHtml = `
                    <button class="btn-chavruta" onclick="sendChavrutaRequest('${user.email}', '${bookName}')">
                        <i class="fas fa-handshake"></i> בקש חברותא
                    </button>`;

                const item = document.createElement('div');
                item.className = 'chavruta-item';
                item.style = "border-bottom: 1px solid #eee; padding: 10px; display: flex; justify-content: space-between; align-items: center;";

                item.innerHTML = `
                    <div style="flex-grow:1">
                        <div style="font-weight:bold; color:var(--primary);">${badge}${displayName}</div>
                        <div style="font-size:0.85rem; color:var(--accent);">לומד כעת: ${user.learning_now || 'לא מעודכן'}</div>
                        <div style="font-size:0.8rem; color:#666;">עיר: ${user.city || 'לא צוין'}</div>
                        <a href="#" style="font-size:0.75rem; color:blue; text-decoration:underline;" 
                           onclick="customAlert('הנה הטלפון של ${displayName}: ${user.phone || 'לא הוזן טלפון'}')">
                           הצג טלפון ליצירת קשר
                        </a>
                    </div>
                    ${buttonHtml}
                `;
        ...
        list.innerHTML = '<div style="text-align:center; color:red;">שגיאה במשיכת נתונים מהענן.</div>';
    }
            ...
            html += `
                <div style="display:flex; align-items:center; padding:10px; background:#fff; border-bottom:1px solid #eee; cursor:pointer;" onclick="closeModal(); showUserDetails('${u.email}')">
                    <div style="display:flex; align-items:center; gap:10px;">
                        <div class="${auraClass}" style="font-size:2rem; color:#cbd5e1; ${auraStyle}"><i class="fas fa-user-circle"></i></div>
                        <div>
...
function unitToDafString(goal) {
    ...
    const isTalmud = libraryDB.talmud.some(b => b.name === goal.bookName);
...
async function completeGoal(goalId) {
    ...
    if (followers && followers.length > 0) {
        const msgs = followers.map(f => ({
            sender_email: 'admin@system', // נשלח מהמערכת כדי שיופיע ב"אחר"
            receiver_email: f.follower_email,
            message: `📢 <strong>עדכון:</strong> המשתמש ${currentUser.displayName} סיים את <strong>${bookName}</strong>!`,
            is_html: true
        }));
...
async function updateProgress(goalId, change) {
    ...
    if (goalCard) {
        // עדכון טקסט
        const textEl = goalCard.querySelector('.goal-progress-text');
        if (textEl) textEl.innerText = unitToDafString(goal);

        const remEl = goalCard.querySelector('.goal-remaining-text');
        if (remEl) remEl.innerText = `${goal.totalUnits - goal.currentUnit} עמודים לסיום`;

        // עדכון רוחב בר (ה-CSS transition יעשה את ההחלקה)
        const barEl = goalCard.querySelector('.progress-bar');
        const percent = Math.min(100, Math.round((goal.currentUnit / goal.totalUnits) * 100));
        if (barEl) barEl.style.width = `${percent}%`;

        // עדכון סטטיסטיקה כללית
        let totalLearned = userGoals.reduce((sum, g) => sum + g.currentUnit, 0);
        document.getElementById('stat-pages').innerText = totalLearned;
        updateRankProgressBar(totalLearned);
    } else {
    ...
    if (goal.targetDate) {
        ...
        if (change > 0) {
            ...
            if (doneBefore < dailyTarget && doneAfter >= dailyTarget) {
                ...
                const taskRow = document.getElementById(`daily-task-${goal.id}`);
                if (taskRow) taskRow.classList.add('daily-goal-reached');
            }
        }
    }
    // --------------------------------------------------------
...
function closeModal() {
    ...
    const generalSearchModal = document.getElementById('generalSearchModal');
    ...
    if (generalSearchModal) generalSearchModal.style.display = 'none';
...
function renderGeneralSearchResults(results, query) {
    ...
    if (results.my_goals && results.my_goals.length > 0) {
        ...
        results.my_goals.forEach(g => {
            groupHtml += `
                <div class="result-item" onclick="closeModal(); switchScreen('dashboard'); setTimeout(() => document.getElementById('goal-card-${g.id}').scrollIntoView({behavior: 'smooth', block: 'center'}), 100);">
    ...
    if (results.my_chavrutas && results.my_chavrutas.length > 0) {
        ...
        results.my_chavrutas.forEach(u => {
            groupHtml += `
                <div class="result-item" onclick="closeModal(); switchScreen('chavrutas'); showUserDetails('${u.email}');">
                    <div class="result-item-title">${highlight(u.name, query)}</div>
    ...
    if (results.chats && results.chats.length > 0) {
        ...
        results.chats.forEach(msg => {
            ...
            groupHtml += `
                <div class="result-item" onclick="closeModal(); openChat('${partnerEmail}', '${displayName.replace(/'/g, "\\'")}');">
    ...
    if (results.books && results.books.length > 0) {
        ...
        results.books.forEach(b => {
            groupHtml += `
                <div class="result-item" onclick="closeModal(); switchScreen('add'); showAddSection('new'); setTimeout(() => { document.getElementById('categorySelect').value = '${b.category}'; populateBooks(); document.getElementById('bookSelect').value = JSON.stringify({name:'${b.name}', units:${b.units}}); }, 500);">
    ...
    if (currentDonationType === 'sub') {
        ...
        if (followers && followers.length > 0) {
            const msgs = followers.map(f => ({
                ...
                receiver_email: f.follower_email,
                message: `📢 <strong>עדכון:</strong> המשתמש ${currentUser.displayName} תרם לחיזוק בית המדרש!`,
                is_html: true
            }));
            await supabaseClient.from('chat_messages').insert(msgs);
        }
...
function renderGoals() {
    ...
    if (activeGoals.length === 0) {
        list.innerHTML = `
            <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; min-height:300px; text-align:center; padding:40px 20px; color:#94a3b8;">
                <i class="fas fa-wind" style="font-size:4rem; margin-bottom:15px; opacity:0.5;"></i>
                <h2 style="margin-bottom:10px; color:var(--text-main);">ריק פה</h2>
                <p style="margin-bottom:20px; font-size:1rem;">המדף שלך נראה כמו המקרר ביום ראשון בבוקר...<br>בוא נוסיף קצת תוכן לנשמה!</p>
                <button class="btn" style="width:auto; background:var(--accent);" onclick="switchScreen('add', document.querySelectorAll('.nav-item')[1])">הוסף לימוד חדש</button>
            </div>`;
    }
    ...
    userGoals.forEach(goal => {
        ...
        const connection = chavrutaConnections.find(c => c.book === goal.bookName);
        let chavrutaHtml = '';
        let scheduleInfo = '';

        if (connection) {
            const partner = globalUsersData.find(u => u.email === connection.email);
            const partnerName = partner ? (partner.name || partner.email) : (connection.name || connection.email || 'חברותא');
            chavrutaHtml = `<div style="font-size:0.9rem; color:#16a34a; font-weight:bold; display:flex; align-items:center; gap:5px; padding:6px 0;"><i class="fas fa-user-friends"></i> לומד ביחד עם ${partnerName}</div>`;

            const scheduleKey = `${connection.email}::${goal.bookName}`;
            const schedules = JSON.parse(localStorage.getItem('chavruta_schedules') || '{}');
            const sched = schedules[scheduleKey];
            if (sched) {
                const daysMap = ['א', 'ב', 'ג', 'ד', 'ה', 'ו', 'ש'];
                const daysStr = sched.days.map(d => daysMap[d]).join(',');
                scheduleInfo = `<div style="font-size:0.85rem; color:#854d0e; background:#fef9c3; padding:2px 8px; border-radius:4px; display:inline-block; margin-top:4px;"><i class="fas fa-clock"></i> <strong>זמן קבוע:</strong> ימים ${daysStr} בשעה ${sched.time}</div>`;
            }
        } else {
            chavrutaHtml = `<button class="btn-chavruta" onclick="openChavrutaSearch('${goal.bookName}')"><i class="fas fa-search-plus"></i> מצא חברותא</button>`;
        }

        const targetDateDisplay = goal.targetDate ? `<span style="font-size:0.8rem; color:#d97706; background:#fef3c7; padding:2px 6px; border-radius:4px; margin-right:5px;">יעד: ${new Date(goal.targetDate).toLocaleDateString('he-IL')}</span>` : '';
        ...
        if (goal.status === 'active') {
            ...
            if (window.newGoalId === goal.id.toString()) {
                div.classList.add('new-goal-highlight');
                div.classList.add('new-book-pulse'); // הבהוב כמו תרומה
            ...
            div.innerHTML = `
                <div class="goal-header">
                    <div>
                        <div class="goal-title" style="display:flex; align-items:center; gap:8px;">
                            ${goal.bookName} ${targetDateDisplay}
                            ${connection ? `<span style="font-size:0.7rem; background:#dcfce7; color:#16a34a; padding:2px 6px; border-radius:10px; display:flex; align-items:center; gap:4px; cursor:pointer;" onclick="openChat('${connection.email}', '${partnerName.replace(/'/g, "\\'")}')" title="פתח צ'אט"><i class="fas fa-user-friends"></i> עם ${partnerName}</span>` : ''}
                        </div>
                        <div style="font-size:0.8rem; color:#666;">${goal.dedication || ''}</div>
                        <div class="goal-progress-text" style="font-size:0.9rem; color:var(--text-main); font-weight:bold; margin-top:5px;">${unitToDafString(goal)}</div>
                    </div>
                    <div class="goal-remaining-text" style="text-align:left; font-size:0.8rem; color:#64748b;">${goal.totalUnits - goal.currentUnit} עמודים לסיום</div>
                </div>
                ...
                <div class="controls-row" style="display: flex; justify-content: space-between; align-items: center; margin-top: 10px;">
                    ...
                    <div style="display: flex; gap: 8px;">
                        ${!connection ? `<button class="btn-icon" onclick="openChavrutaSearch('${goal.bookName}')" title="מצא חברותא"><i class="fas fa-user-plus"></i></button>` : ''}
                        <button class="btn-icon" onclick="openBookChat('${goal.bookName}')" title="צ'אט כללי"><i class="fas fa-comments"></i></button>
                        <button class="btn-icon" onclick="openNotes('${goal.id}')" title="הערות אישיות"><i class="fas fa-sticky-note"></i></button>
                        <button class="btn-icon danger" onclick="deleteGoal(${goal.id})" title="מחק לימוד"><i class="fas fa-trash"></i></button>
                    </div>
...
async function openChavrutaSearch(bookName) {
    ...
    if (title) title.innerText = bookName;
    if (list) list.innerHTML = '<div style="text-align:center; padding:10px;">טוען נתונים...</div>';

    if (modal) modal.style.display = 'flex';
    if (modal) bringToFront(modal);

    // שליפת רשימת המשתמשים שכבר תפוסים בחברותא על הספר הזה
    let busyEmails = new Set();
    try {
        const { data: busyData } = await supabaseClient
            .from('chavruta_requests')
        ...
        if (busyData) {
            busyData.forEach(r => { busyEmails.add(r.sender_email); busyEmails.add(r.receiver_email); });
        }
    } catch (e) { console.error("Error fetching busy users", e); }

    if (list) list.innerHTML = '';

    // סינון: מצא אנשים שלומדים את הספר הזה, והם לא אני
    const matches = globalUsersData.filter(u =>
        u.books && u.books.includes(bookName) && u.email && u.email.toLowerCase() !== currentUser.email.toLowerCase()
    );

    if (matches.length === 0) {
        list.innerHTML = '<div style="text-align:center; padding:10px;">לא נמצאו לומדים אחרים בספר זה כרגע.<br>היה הראשון!</div>';
    } else {
        // מיון: קודם העיר שלי, אחר כך אקראי
        const myCity = currentUser.city ? currentUser.city.trim().toLowerCase() : "";
        const sameCity = matches.filter(u => u.city && u.city.trim().toLowerCase() === myCity);
        const others = matches.filter(u => !u.city || u.city.trim().toLowerCase() !== myCity);

        // ערבוב האחרים
        others.sort(() => Math.random() - 0.5);

        [...sameCity, ...others].forEach(user => {
            const displayName = user.isAnonymous ? "לומד אנונימי" : user.name;

            // אם המשתמש חסום, נדלג עליו או נציג אותו אחרת (כאן נדלג)
            if (blockedUsers.includes(user.email)) return;

            const item = document.createElement('div');
            item.className = 'chavruta-result';

            // יצירת הכפתור - אם המשתמש אנונימי אי אפשר לראות טלפון
            let buttonHtml = '';
            if (user.isAnonymous) {
                buttonHtml = `<button class="btn" style="background:#ccc; cursor:not-allowed;">חסוי</button>`;
            } else if (busyEmails.has(user.email)) {
                buttonHtml = `<button class="btn" style="background:#94a3b8; cursor:not-allowed; font-size:0.8rem; padding:5px 10px;">תפוס</button>`;
            } else {
                if (approvedPartners.has(user.email)) {
                    buttonHtml = `<button class="btn" style="width:auto; font-size:0.8rem; padding:5px 10px; background:#16a34a;" 
                        onclick="showUserDetails('${user.email}')">פרטי קשר</button>`;
                } else {
                    buttonHtml = `<button class="btn" style="width:auto; font-size:0.8rem; padding:5px 10px;" 
    ...
    approvedPartners.forEach(email => {
        ...
        div.innerHTML = `
            ...
            <div style="margin-top:15px; display:flex; gap:10px; flex-wrap:wrap;">
                <button class="btn" style="flex:1; font-size:0.9rem; background-color:#3b82f6;" onclick="showUserDetails('${user.email}')">
                    <i class="fas fa-user"></i> פרופיל
                </button>
                <button class="btn" style="flex:1; font-size:0.9rem; background-color:#8b5cf6; position:relative;" onclick="openChat('${user.email}', '${safeName}')">
                    <i class="fas fa-comments"></i> צ'אט ${unreadBadge}
                </button>
                <button class="btn" style="flex:1; font-size:0.9rem; background-color:#f59e0b;" onclick="openScheduleModal('${user.email}', '${sharedBooks}', '${safeName}')">
                    <i class="fas fa-clock"></i> זמנים
                </button>
                <button class="btn" style="flex:1; font-size:0.9rem; background-color:#0ea5e9;" onclick="openBookText('${safeBook}')">
                    <i class="fas fa-book-reader"></i> פתח ספר
                </button>
                <button class="btn-outline" style="flex:1; font-size:0.9rem; color:#ef4444; border-color:#ef4444;" onclick="cancelChavruta('${user.email}')">
...
function openBookText(bookName) {
    ...
    if (bookName === 'דף היומי') linkKey = 'Daf_Yomi';
        ...
        // Find the linkKey from the libraryDB
        for (const category in libraryDB) {
            const book = libraryDB[category].find(b => b.name === bookName);
            if (book && book.linkKey) {
                linkKey = book.linkKey;
                break;
            }
        }
...
function handleRealtimeMessage(payload) {
    ...
    if (eventType === 'INSERT' && newMsg) {
        ...
        if (newMsg.receiver_email && newMsg.receiver_email.startsWith('book:')) {
            ...
            if (document.getElementById(`chat-window-${bookId}`) && sender !== myEmail) {
                appendMessageToWindow(bookId, newMsg.message, 'other', newMsg.id, newMsg.created_at, false, sender);
                const win = document.getElementById(`chat-window-${bookId}`);
        ...
        if (receiver === myEmail) {
            ...
            if (document.getElementById(`chat-window-${sender}`)) {
                ...
                if (Notification.permission === "granted") {
                    new Notification(`הודעה חדשה מ-${senderDisplayName}`, { body: newMsg.message, icon: "https://cdn-icons-png.flaticon.com/512/2997/2997295.png" });
                }
...
document.addEventListener('keydown', async (e) => {
    ...
    // Data War Toggle (Alt + C + O)
    if (e.altKey && (k === 'c' || k === 'ב')) {
        window.dataWarSeq = true;
    } else if (window.dataWarSeq && (k === 'o' || k === 'ם')) {
        const pass = await customPrompt("הכנס סיסמת מנהל:");
        if (pass === "כל יכול") {
            toggleDataWar();
        } else if (pass) await customAlert("סיסמה שגויה");

        window.dataWarSeq = false;
    } else if (!e.altKey) window.dataWarSeq = false;

    if (e.altKey) {
        if (k === 'a' || k === 'ש') { adminSeq = ['a']; e.preventDefault(); }
        else if ((k === 'r' || k === 'ר') && adminSeq.join('') === 'a') { adminSeq.push('r'); e.preventDefault(); }
        else if ((k === 'i' || k === 'ן') && adminSeq.join('') === 'ar') {
            e.preventDefault();
            adminSeq = [];
            const pass = await customPrompt("הכנס סיסמת מנהל:");
            if (pass === "כל יכול") {
    ...
    filteredUsers.forEach(u => {
        ...
        tr.innerHTML = `
            ...
            <td style="text-align:center; white-space:nowrap;">
                ...
                <button class="admin-btn" style="background:#ef4444; color:white;" onclick="adminDeleteUser('${u.email}')" title="מחק"><i class="fas fa-trash"></i></button>
            </td>
        `;
        tbody.appendChild(tr);
    });
...
async function renderAdminTools() {
    ...
    if (bots && bots.length > 0) {
        bots.forEach(bot => {
            ...
            const deleteButton = `<button class="admin-btn" style="background:#ef4444; color:white; position:absolute; top:5px; left:5px;" onclick="event.stopPropagation(); adminDeleteBot('${bot.email}')"><i class="fas fa-trash"></i></button>`;

            div.innerHTML = `
                ${deleteButton}
                <div style="font-size:2rem;">🤖</div>
                <div style="font-weight:bold; color:#fff;">${bot.display_name}</div>
            `;
            list.appendChild(div);
        });
    } else {
